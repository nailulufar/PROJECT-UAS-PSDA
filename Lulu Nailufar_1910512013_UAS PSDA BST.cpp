...
//fungsi yang untuk mencetak tree secara preOrder
...
int main()
{
    ...
    while (true)
    {
        ...
        printf("[2] Cetak Pre-Order\n");
        printf("[3] Cetak In-Order\n");
        printf("[4] Cetak Post-Order\n");
        printf("[5] Hapus Node\n");
        printf("[6] Reset BST\n");
        printf("[7] Search\n");
            ...
            case '1':
             ...
             //jika pil bernilai '6'
              ...
              case '9' :
			   ...
			   //jika pil bernilai 'A'
               case 'A' :
            		 cout<<"Value terbesar tree adalah: "<<findMax() <<endl;	
               		 cout<<"Value terkecil tree adalah: "<<findMin() <<endl;
               		 _getch();
                     break;
